...
case_name = 'gFHR_graphite_iterable' # Name of the input folder
...
#%% Burnup cycle
pebbles_dict = {'u_fuel_pebble':{'pebbles_frac':7/51,'mat_name':'fuel', 'r_fuel_kernel':0.02125, 'Ntrisos':9022, 'threshold_type':'burnup', 'threshold_dir':+1, 'threshold':168},
                'u_graph_pebble':{'pebbles_frac':44/51}}
...
#%% Outputing
output_folder_name = 'gFHR_graphite_test' # Name of the output folder
verbosity_mode = 1
inventory_names = []
