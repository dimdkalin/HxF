...
case_name = 'gFHR_graphite' # Name of the input folder
...
Nsteps = 1000
neutrons_per_cycle = [100000]*(Nsteps)
decay_step = 0 # days

#%% Burnup cycle
pebbles_dict = {'u_fuel_pebble':{'mat_name':'fuel', 'r_fuel_kernel':0.02125, 'Ntrisos':9022, 'threshold_type':'burnup', 'threshold_dir':+1, 'threshold':168},
                'u_graph_pebble':{}}
...
#%% Outputing
output_folder_name = 'gFHR_graphite_force_replace' # Name of the output folder
verbosity_mode = 1
inventory_names = []
